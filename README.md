...
The dashboard provides role-based HR statistics, employee insights, department distribution and leave information.

![HRFlow EMS Dashboard](docs/screenshots/dashboard.png)

### 📋 HR Dashboard Overview

Additional dashboard widgets provide pending leave requests, upcoming leave periods, company announcements and upcoming employee birthdays.

![HRFlow EMS Dashboard Overview](docs/screenshots/dashboard-details.png)

### 👥 Employee Management

Employees can be managed together with their departments, positions, system accounts and application roles.

![HRFlow EMS Employee Management](docs/screenshots/employees.png)

### 👤 Employee Profile

Employee profiles contain personal, contact and organizational information with profile image support.

![HRFlow EMS Employee Profile](docs/screenshots/employee-profile.png)

### 📝 Leave Management

Leave requests support approval workflows with pending, approved, rejected and cancelled states.

![HRFlow EMS Leave Management](docs/screenshots/leave-management.png)

### 💰 Payroll Management

Payroll records are generated by period and include employee salary, overtime, bonus and deduction calculations with status tracking.

![HRFlow EMS Payroll Management](docs/screenshots/payroll-management.png)

### 🔔 Notifications & Request Logging

The application includes user-specific notifications together with middleware-based HTTP request logging for system monitoring.

![HRFlow EMS Notifications and Request Logging](docs/screenshots/notifications-logs.png)
